...
AgentStack skills are workflows, not reference material. A skill should tell an agent how to do a repeatable piece of engineering work and when to stop.
...
Compress wording whenever a skill starts to feel bloated. Preserve behavior, constraints, exact names, paths, commands, schemas, and examples that carry meaning.
