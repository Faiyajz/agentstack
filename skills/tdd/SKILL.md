...
- If the test cannot fail for the expected reason, fix the test or the understanding before implementation.
...
- Run the focused test again, then the full relevant test suite before finishing.
...
- Do not weaken or delete existing tests to make the new test pass unless the task explicitly changes that behavior.
