...
- Identify what would make the design invalid: scale assumptions, dependency limits, regulatory constraints, team capability, cost, or migration risk.
...
- **Failure Modes** *(when relevant)*: how the design behaves under dependency, load, data, or operator failure.
...
- Prefer a clear recommendation over a neutral survey of options.
