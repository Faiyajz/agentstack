...
5. Keep names lowercase, hyphenated, and shell-safe. Preserve an obvious repo prefix such as `feature/` only if the ticket ID remains visible.
...
- Do not rename or delete existing branches unless explicitly asked.
