...
- Check whether comments refer to an outdated diff before treating line references as current.
...
- Keep separate issues separate when multiple comments point to different fixes.
...
- If accepting a suggestion would make the code worse, decline it with a brief reason.
