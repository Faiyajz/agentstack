...
4. Stage only intended files. Check new, generated, large, lockfile, and deletion changes before staging. Never stage secrets.
5. Use the user's message if provided. Otherwise write a Conventional Commit message: `type(scope): subject`.
6. Create the commit and report the hash, message, and files committed.
