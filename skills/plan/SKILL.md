...
- If the source input is wrong or stale, stop and update it before planning from it.
...
- Isolate migrations, risky rollout steps, and broad refactors unless they are inseparable from a task.
...
- Do not create a plan for trivial, decision-complete work unless the user explicitly asks.
